  ...
  return (
    <div className="min-h-screen flex">
      ...
      <div className="hidden lg:flex w-1/2 bg-slate-900 items-center justify-center relative overflow-hidden">
        <div className="absolute top-0 left-0 ml-10 mt-10 w-72 h-72 rounded-full bg-blue-600 blur-3xl opacity-20" />
        <div className="absolute bottom-0 right-0 mr-10 mb-10 w-96 h-96 rounded-full bg-indigo-500 blur-3xl opacity-20" />
